...
#chap-header("6", "Magic and Powers", "Extraordinary Abilities")
...
#float[#floating-table(
  ...
  [*Result*],
  [1--2],
  [*Psychic Feedback.* The caster takes Psychic damage equal to the power's Focus cost, reduced by Ward. The caster is Dazed until the end of their next turn. _(The mildest outcome --- similar to arcane backlash.)_],
  [3--4],
  [*Sensory Overload.* The caster's senses are overwhelmed by a flood of unfiltered perception. The caster is *Blinded* and *Deafened* (save ends both). While this effect lasts, the caster perceives fragments of nearby creatures' thoughts and emotions --- disorienting but occasionally informative, at the GM's discretion.],
  [5--6],
  [*Reality Fracture.* The fabric of space distorts in a Burst 2 centered on the caster. All creatures in the area (including the caster) are teleported to random unoccupied squares within 10 squares of their current position. The GM determines the destinations. Additionally, the affected area becomes *difficult terrain* for the remainder of the encounter as space knits itself back together.],
  [7--8],
  [*Ego Dissolution.* The caster's psychic identity partially unravels. The caster loses *Focus* equal to 3 × the attempted power's tier and is *Stunned* for 1 round (no save). At the GM's discretion, a fragment of the caster's thoughts may be broadcast to all psychically sensitive creatures within 30 squares --- allies and enemies alike.],
  [9],
...
#power-description(
  ...
  1,
  "2",
  "On hit: 100% Chemical damage. The target's Armor value is reduced by 1 until the end of the encounter (stacks up to 3 times).",
  keywords: ("Acid",),
  range: "Cone 5",
  difficulty: "3",
  cost: "1 Increment",
...
#power-description(
  ...
  2,
  "2; sustain 1",
  "On hit: All creatures in the area take 100% Chemical damage and are Poisoned (save ends). The cloud persists as a zone of light obscurement as long as you sustain it; creatures that enter or start their turn in the zone take 100% Chemical damage.",
  keywords: ("Acid", "Zone"),
...
#power-description(
  ...
  3,
  "3",
  "On hit: 200% Lightning damage, and the target is stunned for one round.",
  keywords: ("Lightning",),
...
#power-description(
  ...
  4,
  "3",
  "A torrent of caustic liquid pours over the area. All creatures in the area take 200% Chemical damage. Their armor and Hardness are permanently reduced by 3 (until repaired). On each subsequent turn for 3 rounds, affected creatures take ongoing 100% Chemical damage (save ends the ongoing damage, but not the armor reduction).",
  keywords: ("Acid",),
...
#power-description(
  ...
  3,
  "2 AP; sustain 1 AP",
  "You summon a storm cloud in the area. When you cast this prayer and at the start of each of your subsequent turns while you sustain it, a bolt of lightning strikes a creature of your choice within the area, dealing 200% Lightning damage.",
  domain: "Maiden",
...
#power-description(
  ...
  1,
  "2 AP",
  "You channel a potent toxin through your hand or weapon. Your next melee attack or touch before the end of your turn deals an additional 100% of your catalyst's damage as Chemical damage. If the target takes damage, it must pass a resistance check or become Poisoned (save ends).",
  domain: "Serpent",
  keywords: ("Divine", "Poison"),
  difficulty: "3",
  cost: "1 Increment",
  resistance: "D3 Stamina",
  tap: "The target also takes ongoing 3/T Chemical damage (save ends) regardless of whether the Poisoned save succeeds.",
)
...
#power-description(
  ...
  2,
  "2 AP; sustain 1 AP",
  "You exhale a cloud of noxious fumes that fills the area. The zone provides light obscurement. Any creature that enters or starts its turn in the zone takes 100% Chemical damage and must pass a resistance check or be Poisoned and Weakened (-2d on attack rolls) for 1 round. The zone lasts as long as you sustain it.",
  domain: "Serpent",
...
#power-description(
  ...
  3,
  "2 AP",
  "You curse the target with a wasting toxin that saps their vitality. The target takes 200% Chemical damage. On a failed resistance check, the target is Diseased (save ends): while Diseased, all healing received by the target is halved, and the target takes ongoing 5/T Chemical damage at the start of each of its turns.",
  domain: "Serpent",
...
#power-description(
  ...
  4,
  "3 AP",
  "You infect a target with a virulent plague that spreads to nearby enemies. The primary target takes 200% Chemical damage and is automatically Diseased (save ends). At the end of each of the primary target's turns, all enemies within 2 squares of it must pass a resistance check or also become Diseased. The disease spreads in this manner up to 3 times. Diseased creatures have their healing halved and take ongoing 5/T Chemical damage.",
  domain: "Serpent",
  keywords: ("Divine", "Poison", "Disease"),
  difficulty: "8",
  cost: "3 Increments",
...
#power-description(
  ...
  5,
  "3 AP",
  "You inject a target with a toxin that attacks the boundary between life and death. The target takes 300% Chemical damage, ignoring Ward. On a failed resistance check, the target cannot be healed by any means (save ends). While this effect persists, any damage the target takes also reduces its maximum HP by the same amount. Maximum HP lost this way is restored when the effect ends.",
  domain: "Serpent",
  keywords: ("Divine", "Poison"),
  difficulty: "10",
  cost: "3 Increments",
