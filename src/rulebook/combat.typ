...
#pftab(
  ...
  [*System Disabled*],
  [1],
  [*Weapons:* One mounted weapon (chosen randomly) cannot fire.],
  [2],
  [*Drive:* Speed halved (stacks with the Heavily Damaged penalty). If already halved, the vehicle is immobilized.],
  [3],
  [*Steering:* Piloting checks suffer --4 dice. The vehicle cannot turn more than 45 degrees per Drive action.],
  [4],
  [*Sensors:* Gunners suffer --2 dice to all attacks. The vehicle cannot detect threats beyond visual range.],
  [5],
  [*Armor Breach:* The vehicle's Armor is reduced by a quarter (round down). Crew lose the benefit of cover from one facing (GM determines which).],
  [6],
  [*Cargo:* Passenger compartment or cargo hold is compromised. Passengers take 2D8 damage from shrapnel and debris; loose cargo is destroyed or scattered.],
)
...
#pftab(
  ...
  [*System Disabled*],
  [1],
  [*Main Battery:* One main weapon system cannot fire until repaired.],
  [2],
  [*Point Defense:* Point-defense weapons go offline. The vessel cannot intercept missiles or engage tactical-scale targets.],
  [3],
  [*Engines:* Speed reduced by 1 band per round (minimum 0). If already at 0, the vessel is adrift.],
  [4],
  [*Helm:* Navigation controls unresponsive. The vessel cannot maneuver --- no Evasive Action, Present Broadside, or Ramming Speed until repaired. The vessel drifts in its current direction.],
  [5],
  [*Shields:* Ward generators fail. The vessel's Ward drops to 0.],
  [6],
  [*Sensors:* Long-range detection is lost. All attacks beyond Close range suffer an additional +2 difficulty. The vessel cannot detect threats at Extreme range.],
  [7],
  [*Hull Breach:* Compartments near the impact are open to the elements. Crew in the affected section take 2D10 damage and must make an Athletics check (difficulty 4) or be swept out. In a Fog zone, the breach floods the section with Fog --- treat as Moderate Fog exposure.],
  [8],
  [*Magazine:* Ammunition stores or power conduits are hit. An internal explosion deals Hull damage equal to 10% of the vessel's maximum Hull. If the magazine has already been hit, the second hit deals 25%.],
)
...
#float(
  floating-table(
    ...
    [1],
    [1],
    [Tactical scale. Common on civilian skimmers.],
    [Combat Shield Generator],
    [2],
    [8],
    [2],
    [2],
    [Tactical scale. Standard military issue.],
    [Heavy Shield Generator],
    [3],
    [14],
    [3],
    [3],
    [Tactical scale. Heavy skimmers and APCs.],
    [Ship Shield Array],
    [3],
    [5],
    [6],
    [4],
    [Strategic scale. Small to medium vessels.],
    [Capital Shield Array],
    [4],
    [8],
    [8],
    [6],
    [Strategic scale. Large warships.],
    [Dreadnought Shield Array],
    [5],
    [12],
    [12],
    [8],
    [Strategic scale. Only the largest vessels.],
  ),
)
...
#float(
  floating-table(
    ...
    [Ct--Cl],
    [S],
    [Point Defense, Burst 3],
    [Light Mist Gun Battery],
    [2],
    [8+D6],
    [3],
    [3],
