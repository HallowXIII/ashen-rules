...
#pftab(
  ...
  [¼],
  [Burst 2/10],
  [Dazed + Blinded 1 round (D4 Stamina negates)],
  [_#feathers 300_],
  [Plasma Grenade],
  [3],
  [Grenade],
  [¼],
  [Burst 2/10],
  [12+D10 Thermal damage, Burning (save ends)],
  [_#feathers 600_],
  [EMP Grenade],
  [3],
  [Grenade],
  [¼],
  [Burst 3/10],
  [No damage; all magitek and shield generators in area shut down for 2 rounds. D6 Stamina negates for worn items.],
  [_#feathers 800_],
  [Mist Grenade],
  [4],
  [Grenade],
  [¼],
  [Burst 3/10],
  [Creates Dense Fog zone for 3 rounds. Creatures in zone at start of turn suffer Dense Fog exposure.],
  [_#feathers 1000_],
)
...
#pftab(
  ...
  [¼],
  [Self/Touch],
  [Recover 2D4+4 HP per round for 3 rounds],
  [_#feathers 500_],
  [Potent Regeneration Draught],
  [2],
  [Potion],
  [¼],
  [Self/Touch],
  [Recover 2D6+8 HP per round for 3 rounds],
  [_#feathers 650_],
  [Potent Ether Flask],
  [2],
  [Potion],
  [¼],
  [Self/Touch],
  [Recover 2D6+18 Focus],
  [_#feathers 500_],
  [Vermillion Healing Potion],
  [3],
  [Potion],
  [¼],
  [Self/Touch],
  ...
  [¼],
  [Self/Touch],
  [Gain resistance 5 to one damage type (chosen when brewed) for 1 encounter],
  [_#feathers 900_],
  [Superior Ether Flask],
  [4],
  [Potion],
  [¼],
  [Self/Touch],
  [Recover 4D6+30 Focus],
  [_#feathers 1000_],
  [Scarlet Healing Potion],
  [5],
  [Potion],
  [¼],
  [Self/Touch],
...
#pftab(
  ...
  [*Effect*],
  [*Cost*],
  [Revitalization Charge],
  [0],
  [Special],
  [¼],
  [5 squares],
  [Revive a dead Immortal at full HP and Focus],
  [_#feathers 5000_],
  [Pure Land Water],
  [5],
  [Special],
...
#pftab(
  ...
  [2],
  [¼],
  [1 Magnitude for Ritual or Alchemy checks],
  [_#feathers 600_],
  [Alchemical Reagents (Rare)],
  [2],
  [¼],
  [3 Magnitude for Ritual or Alchemy checks],
  [_#feathers 2000_],
  [Alchemical Reagents (Precious)],
  [4],
  [¼],
  [6 Magnitude for Ritual or Alchemy checks],
  [_#feathers 4500_],
  [Prima Materia, Vial],
  [6],
  [¼],
  [Legendary crafting ingredient; glows with inner power],
  [—\*],
  [Materia Nigra, Vial],
  [6],
  [¼],
  [Corrupted Prima Materia; ingredient for some Legendary Rituals. Corrupts lesser rituals],
  [—\*],
  [Materia Rubrior, Vial],
  [6],
  [¼],
  [Realized Prima Materia; ingredient for some Legendary Rituals. Worth 20 Magnitude],
  [—\*],
)
...
#pftab(
  ...
  [1],
  [_#feathers 10_],
  [+2d to Athletics checks for climbing when secured],
  [Grappling Hook],
  [½],
  [_#feathers 25_],
  [Allows rope to be thrown and anchored at range],
  [Climbing Kit],
  [2],
  [_#feathers 50_],
  [+2d to Athletics checks for climbing; prevents falls on 1 failed check],
  [Camping Kit],
  [3],
  [_#feathers 30_],
  [Tent, bedroll, fire starter. Required for comfortable rest in the field],
  [Healer's Kit (10 uses)],
  [1],
  [_#feathers 100_],
  [Required to perform Alchemy checks for healing. Each use expended per patient],
  [Alchemy Kit],
  [3],
  [_#feathers 200_],
  [Required to perform Alchemy checks and brew potions],
  [Electronics Kit],
  [2],
  [_#feathers 150_],
  [Required to perform Electronics checks],
  [Magitek Kit],
  [2],
  [_#feathers 200_],
  [Required to perform Magitek checks. Charge: 2],
  [Lantern],
  [½],
  [_#feathers 5_],
  [Bright light in 10 squares, dim light in 20],
  [Rations (1 week)],
  [1],
  [_#feathers 10_],
  [Sufficient food for one person for seven days],
  [Binoculars],
  [½],
  [_#feathers 50_],
  [+2d to Awareness checks at long range],
  [Comm Unit],
  [¼],
  [_#feathers 100_],
  [Encrypted short-range communication (range: ~5 km)],
  [Lockpick Set],
  [¼],
  [_#feathers 75_],
  [Required to pick mechanical locks. +2d to Infiltration checks for locks],
  [Manacles],
  [½],
  [_#feathers 30_],
  [D6 Athletics to break free],
)
...
#pftab(
  ...
  [¼],
  [_#feathers 30_],
  [Weapon-mountable. Bright light 10 squares. As 1 AP action, Dazzle an adjacent creature (D3 Stamina or Blinded 1 round)],
  [Fog-Shielded Lantern],
  [½],
  [_#feathers 150_],
  [Bright light 10 squares, dim light 20. Shielded emission does not attract Fog creatures],
  [IR Goggles],
  [¼],
  [_#feathers 300_],
  [See in darkness. Spot heat signatures. +2d to Awareness in low light or darkness. Charge: 1],
  [Combat Visor],
  [¼],
  [_#feathers 500_],
  [Heads-up display. Negates concealment penalties from smoke and dim light. +1d Marksmanship. Charge: 1],
  [Mist Filter],
  [¼],
  [_#feathers 200_],
  [Reduces Fog exposure severity by one step (Extreme → Dense, Dense → Light). Lasts 8 hours per filter cartridge],
  [Rebreather],
  [½],
  [_#feathers 400_],
  [Full respiratory protection. Negates Fog exposure effects and airborne poisons for 4 hours per canister],
  [Multi-Spectrum Sensor],
  [½],
  [_#feathers 350_],
  [Handheld scanner. Detects magical, thermal, and radiation signatures within 15 squares. +2d to Awareness for detection. Charge: 1],
  [Motion Sensor],
  [¼],
  [_#feathers 250_],
  [Deployable. Alerts to movement within 15 squares for 8 hours. Can be linked to a comm unit],
  [Signal Flare Kit (6)],
  [½],
  [_#feathers 50_],
  [Visible at extreme range. Can mark locations or signal allies. Burns for 1 minute],
  [Grapnel Launcher],
  [1],
  [_#feathers 200_],
  [Fires a grappling hook up to 20 squares. 1 AP to fire. Includes 50 ft integrated line],
  [Portable Fog Ward],
  [1],
  [_#feathers 800_],
  [Creates a 2-square safe zone where Fog exposure is suppressed for 8 hours. Charge: 3],
  [Advanced Comm Unit],
  [¼],
  [_#feathers 500_],
  [Encrypted long-range communication (~50 km). Fog-resistant signal. Charge: 1],
  [Breaching Charge],
  [½],
  [_#feathers 400_],
  [Destroys doors, walls, and barricades. 30+3D10 damage to structures; Burst 1 to creatures adjacent to the breach],
)
