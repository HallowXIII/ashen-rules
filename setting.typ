...
#set page(paper: "a4")
#set document(title: "Ashen: Game Master's Guide")
#set text(font: "Libre Baskerville")

#align(center, text(24pt)[*The Ashen Game Master's Guide*])
...
=== Prologue. How The World Was Created

#flavor("This text is a translation from the 'Âl i pHethkê yi Ndang', a religious work favored by the devotees of the Boar-Mother.")
