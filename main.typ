...
When you have picked your race, pick three of your attributes (page xx) to start
at 2. The rest start at 1.
...
=== 4. Buy Equipment
Each character begins the game with some amount of money that can be used to buy
gear and items for your character.
...
to the Impose, Influence and Perform skills.
...
Advances are unlocked by spending experience points during downtime. Insert more
...
- *Fire Mode (FM):* For ranged weapons only. S = single shot, SA N = semi-automatic (N shots per burst), FA N = full automatic (N shots per burst). Melee weapons use "—".
- *Special:* Any keywords or unique properties the weapon has.

==== Weapon Keywords

- *Assault:* Hip-fire penalty is halved (-1 instead of -2 for single fire, -2 instead of -4 for automatic fire).
...
#table(
  ...
  [Dragon Guard Flamethrower], [3], [_Ƒ 2500_], [9+2D8 T], [0], [1 (M)], [1], [Cone 8], [S], [Burning],
  [Irradiated Battle Rifle], [3], [_Ƒ 2800_], [12+D10], [0], [2 (M)], [2], [Long], [SA 3], [Irradiated],
...
#table(
  ...
  [Magnetic Sniper Rifle, Gauss], [4], [_Ƒ 6000_], [25+D10 I], [5], [3 (H)], [2], [Very Long], [S], [Heavy, Reliable],
...
#table(
  ...
  [Healer's Kit (10 uses)], [1], [_Ƒ 100_], [Required to perform Medicine checks. Each use expended per patient],
