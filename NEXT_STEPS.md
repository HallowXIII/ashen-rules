...
[x] Add item descriptions for named items that lack them (e.g. reliquaries in the table) and add missing stat lines for described items that lack table entries.
